  ...
  },
  {
    ...
    drills: [
      { name: "Individual Stretching", time: "5 min", desc: "Light individual stretching to close out the warm-up." },
      {
        ...
        desc: "Simple continuous fast-break drill: 3 offense vs 2 defense at one end, ball kicked out of the middle early so the wing can attack and read 2-on-1 (middle) or the weak-side rim runner (1-on-0). Only the rebounder carries over into the next wave, joined by 2 fresh players from the sideline. Runs continuously in both directions.",
      },
      {
        name: "Full-Court Sprint Shooting",
        time: "10 min",
        drillRef: "full-court-sprint-shooting",
        desc: "Two lines at opposite baseline corners. Sprint diagonally to the far free-throw line, catch a timed pass in stride, and shoot immediately. Collect your own rebound and join the line at that end; the passer becomes the next sprinter. Continuous in both directions, so both baskets stay busy.",
      },
      {
        name: "5×2 Free Throw Challenge (Break)",
        time: "10 min",
        drillRef: "five-by-two-free-throws",
        desc: "Break between the two Full-Court Sprint Shooting reps. Split into two groups: one shoots 2 free throws per player, rotating through the group, until everyone has taken 5 trips (10 attempts each); then switch, so the other group shoots its own 5×2 while the first rebounds. Whoever finishes with fewer than 5 makes runs a suicide.",
      },
      {
        name: "Full-Court Sprint Shooting (Repeat, Other Side)",
        time: "10 min",
        drillRef: "full-court-sprint-shooting",
...
const DRILLS = [
  ...
  },
  {
    ...
    name: "11 Men — Continuous 3-on-2 Fast Break",
    category: "Offense",
    summary: "Continuous full-court conditioning and transition drill: 3-on-2 fast breaks in both directions, kicking the ball out of the middle early and reading 2-on-1 vs. the rim runner. Only the rebounder carries over into the next wave.",
    objective: "Build fast-break decision-making (kick out of the middle, draw a defender, then 2-on-1 or weak-side rim runner) and transition defense under fatigue, in a drill that runs continuously in both directions.",
    setup: "3 offensive players start at one baseline — 1 in the middle, 2 wide on the wings — attacking 2 defenders positioned near the free-throw line at the other end. Two more players wait on the sideline at each end, ready to sprint in as the next wing runners.",
    steps: [
      "The middle ball-handler pushes it up the floor but kicks out to a wing as soon as possible — no holding the ball centrally.",
      "The wing attacks the rim off the catch, forcing one of the two defenders to step up and help.",
      "If the middle is open, the wing kicks it back to the trailer in the middle for a 2-on-1 against the remaining defender.",
      "If the middle passing lane is covered instead, the wing finds the rim runner filling the opposite lane for an open finish, 1-on-0.",
      "Play out the possession — score, miss, or turnover.",
      "Only the rebounder continues on as an attacker for the next wave, breaking back the other way immediately — two fresh players sprint in from the sideline to fill the two wing spots alongside them.",
      "The two players who didn't get the rebound go to the back of the line; two new defenders, next in line at that end, step in to defend the new wave.",
      "Repeat continuously in both directions.",
    ],
    coachingPoints: [
      "Kick the ball out of the middle immediately — the middle player's job is to advance and release it, not to attack himself.",
      "The wing's drive is a decision-maker, not necessarily a finish: draw a defender, then read middle-for-2-on-1 or weak-side rim runner for 1-on-0.",
      "Whoever gets the rebound is the only carryover to the next wave — everyone else rotates out or comes in fresh, which is what keeps 11 players constantly involved.",
      "This is a conditioning drill as much as a skill drill — the next wave should already be sprinting in, no standing around.",
    ],
    diagrams: [
      {
  ...
  {
    id: "full-court-sprint-shooting",
    name: "Full-Court Sprint Shooting",
    category: "Offense",
    source: "https://www.sportplan.net/drills/Basketball/Shooting/Full-court-shooting-drill-b602099.jsp",
    summary: "Continuous full-court running drill that pairs conditioning with catch-and-shoot reps at both baskets — built for a gym with only two hoops available.",
    objective: "Combine conditioning with game-speed catch-and-shoot reps, using the full length of the court so both baskets stay in constant use.",
    setup: "Two lines start at opposite baseline corners — diagonal corners of the full court, one line at each basket. Each line needs a supply of balls.",
    steps: [
      "The first player in each line sprints diagonally across the court toward the free-throw line area at the opposite basket.",
      "As they arrive, the next player in that opposite line delivers a pass — timed to meet the sprinting player in stride, not to a standing target.",
      "The sprinting player catches in rhythm and shoots immediately from around the free-throw line.",
      "The shooter collects their own rebound, then joins the back of the line they just shot at (the opposite end from where they started).",
      "The player who made the pass becomes the next sprinter, running the same pattern toward the other basket.",
      "The drill runs continuously in both directions, so both baskets are always in use.",
    ],
    coachingPoints: [
      "Full sprint on the way in, not a jog — this is a conditioning drill as much as a shooting drill.",
      "The pass should lead the shooter into the shot, timed so they can catch and rise without breaking stride.",
      "Insist on game-speed footwork on the catch (inside foot down first, squared to the rim) even once players get tired.",
      "Rotate shooting spots (wing, top, opposite wing) every few reps so it isn't always the same straight-line sprint and catch.",
    ],
  },
  {
    id: "five-by-two-free-throws",
    name: "5×2 Free Throw Challenge",
    category: "Offense",
    summary: "Team free-throw accountability drill: two groups alternate shooting (2 at a time) and rebounding until everyone has taken 5 trips to the line — anyone under 5 makes runs a suicide.",
    objective: "Build free-throw composure under fatigue and team accountability — shooting in front of teammates with a real consequence attached, not just quiet reps.",
    setup: "Split the team into two groups at one basket. One group shoots, the other rebounds and feeds.",
    steps: [
      "One player from the shooting group takes 2 free throws while a rebounder from the other group retrieves and feeds the ball.",
      "The next player in the shooting group steps in and takes their 2 free throws — rotate through the whole shooting group this way.",
      "Keep cycling through the shooting group until every player in it has taken 5 trips of 2 (10 attempts total each).",
      "Switch roles: the group that was rebounding now shoots its own 5×2, while the first group rebounds.",
      "Track makes for every player throughout.",
      "Anyone who finishes with fewer than 5 makes (out of 10) runs a suicide.",
    ],
    coachingPoints: [
