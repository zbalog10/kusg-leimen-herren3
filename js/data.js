  ...
  },
  {
    ...
    diagram: {
      ...
      actions: [
        ...
        { type: "cut", path: [{ x: 55, y: 62 }, { x: 50, y: 45 }, { x: 30, y: 8 }] },
        { type: "screen", at: { x: 50, y: 45 }, angle: 0 },
        { type: "cut", path: [{ x: 30, y: 55 }, { x: 50, y: 45 }, { x: 70, y: 8 }] },
        { type: "cut", path: [{ x: 10, y: 68 }, { x: 50, y: 64 }] },
        { type: "pass", from: { x: 85, y: 62 }, to: { x: 50, y: 64 } },
        { type: "cut", path: [{ x: 30, y: 8 }, { x: 15, y: 40 }, { x: 10, y: 68 }] },
        { type: "cut", path: [{ x: 85, y: 62 }, { x: 70, y: 15 }, { x: 30, y: 8 }] },
        { type: "screen", at: { x: 70, y: 8 }, angle: 0 },
        { type: "pass", from: { x: 50, y: 64 }, to: { x: 10, y: 68 } },
        ...
        { type: "pass", from: { x: 10, y: 68 }, to: { x: 50, y: 55 } },
      ],
    },
    steps: [
      {
