...
const SET_PLAYS = [
  ...
  },
  {
    ...
    diagram: {
      players: [
        { id: "1", label: "1", x: 66, y: 61 },
        { id: "2", label: "2", x: 34, y: 61 },
        { id: "3", label: "3", x: 90, y: 44 },
        { id: "4", label: "4", x: 10, y: 44 },
        { id: "5", label: "5", x: 50, y: 45 },
      ],
      actions: [
        { type: "pass", from: { x: 66, y: 61 }, to: { x: 90, y: 44 } },
        { type: "cut", path: [{ x: 66, y: 61 }, { x: 50, y: 45 }, { x: 30, y: 8 }] },
        { type: "screen", at: { x: 50, y: 45 }, angle: 0 },
        { type: "cut", path: [{ x: 34, y: 61 }, { x: 50, y: 45 }, { x: 70, y: 8 }] },
        { type: "cut", path: [{ x: 10, y: 44 }, { x: 50, y: 64 }] },
        { type: "pass", from: { x: 90, y: 44 }, to: { x: 50, y: 64 } },
        { type: "cut", path: [{ x: 30, y: 8 }, { x: 15, y: 40 }, { x: 10, y: 44 }] },
        { type: "cut", path: [{ x: 90, y: 44 }, { x: 70, y: 15 }, { x: 30, y: 8 }] },
        { type: "screen", at: { x: 70, y: 8 }, angle: 0 },
        { type: "pass", from: { x: 50, y: 64 }, to: { x: 10, y: 44 } },
        { type: "cut", path: [{ x: 50, y: 64 }, { x: 40, y: 25 }] },
        { type: "cut", path: [{ x: 50, y: 45 }, { x: 45, y: 35 }] },
        { type: "screen", at: { x: 40, y: 25 }, angle: 90 },
        { type: "screen", at: { x: 45, y: 35 }, angle: 90 },
        { type: "cut", path: [{ x: 70, y: 8 }, { x: 55, y: 30 }, { x: 50, y: 55 }] },
        { type: "pass", from: { x: 10, y: 44 }, to: { x: 50, y: 55 } },
      ],
    },
    steps: [
      {
