  ...
  },
  {
    ...
    drills: [
      ...
      },
      {
        ...
        desc: "Break between the two Full-Court Sprint Shooting reps. Split into two groups, one at each basket, shooting at the same time — within each group, players rotate 2 free throws each until everyone has taken 5 trips (10 attempts each). Whoever finishes with fewer than 5 makes runs a suicide.",
      },
      {
...
const DRILLS = [
  ...
  },
  {
    ...
    category: "Offense",
    summary: "Team free-throw accountability drill: both groups shoot at the same time, one at each basket, rotating shooter and rebounder within the group until everyone has taken 5 trips to the line — anyone under 5 makes runs a suicide.",
    ...
    setup: "Split the team into two groups, one at each basket, so both groups shoot at the same time.",
    steps: [
      "Within each group, one player takes 2 free throws while a teammate from the same group rebounds and feeds.",
      "The next player in that group steps in and takes their 2 free throws — rotate through the group this way.",
      "Both groups run this at the same time, each at its own basket.",
      "Keep cycling through each group until every player in it has taken 5 trips of 2 (10 attempts total each).",
